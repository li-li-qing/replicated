...
function A:RunMatrix()
    ...
    if type(visualGuides) ~= "table" or (tonumber(visualGuides.version) or 0) < 12 or type(visualGuides.Describe) ~= "function"
        ...
        or (tonumber(visualGuides.RangeDiffRenderContractVersion) or 0) < 1
    ...
    if type(rangeAssist) ~= "table" or (tonumber(rangeAssist.VisualGuideContractVersion) or 0) < 9
        ...
        or (tonumber(rangeAssist.RefreshCadenceContractVersion) or 0) < 2
        or (tonumber(rangeAssist.MotionStabilityContractVersion) or 0) < 1
        or (tonumber(rangeAssist.AspectSafeProjectionContractVersion) or 0) < 1
        ...
        or (tonumber(S.Services.ScreenProjectionV3.RangeRigidBatchContractVersion) or 0) < 1
        or (tonumber(S.Services.ScreenProjectionV3.RangeAnchorStabilityContractVersion) or 0) < 1
        or (tonumber(S.Services.ScreenProjectionV3.RangeAspectSafeCameraContractVersion) or 0) < 1
    ...
    if type(buffHealth) ~= "table" or (tonumber(buffHealth.observationContractVersion) or 0) < 2
        ...
        or (tonumber(gearV3.version) or 0) < 5 or (tonumber(gearV3.PartialApplyContractVersion) or 0) < 1
        or (tonumber(gearV3.TitleEffectAuthorityContractVersion) or 0) < 1
        or type(gearV3.GetCurrentShowingAppellationType) ~= "function"
        ...
        or (tonumber(buffDisplay.BuffHeadMarkerContractVersion) or 0) < 10
        ...
        or (tonumber(S.UIV3.BuffHeadMarkersV3.SplitInfoTextLayoutContractVersion) or 0) < 2
        or (tonumber(S.UIV3.BuffHeadMarkersV3.TargetDistanceStableSlotContractVersion) or 0) < 1
        or (tonumber(S.UIV3.BuffHeadMarkersV3.MirroredInfoSlotContractVersion) or 0) < 1
        or (tonumber(S.UIV3.BuffHeadMarkersV3.IndependentHudSlotContractVersion) or 0) < 1
    ...
    if type(buffHudCalibration) ~= "table" or (tonumber(buffHudCalibration.version) or 0) < 3
        ...
        or (tonumber(buffHudCalibration.IndependentHudSlotPreviewContractVersion) or 0) < 1
