...
local function ShowSuitePage(pageId)
    return S.UIHostManager ~= nil and type(S.UIHostManager.OpenPage) == "function" and S.UIHostManager:OpenPage(pageId) == true
end

local function OpenDailyTrackingSettings()
    return S.UIHostManager ~= nil and type(S.UIHostManager.OpenSettings) == "function" and S.UIHostManager:OpenSettings("tasks") == true
end

local function OpenBondSettings()
    return S.UIHostManager ~= nil and type(S.UIHostManager.OpenSettings) == "function" and S.UIHostManager:OpenSettings("bonds") == true
end
...
ServiceModule({
    ...
    OpenSettings=function() return ShowSuitePage("life_trade") end,
...
ServiceModule({
    ...
    OpenSettings=function() return ShowSuitePage("life_activity") end,
...
ServiceModule({
    ...
    OpenSettings=function() return ShowSuitePage("life_treasure") end,
...
ServiceModule({
    ...
    OpenSettings=function() return ShowSuitePage("life_fishing") end,
    Tasks={"fishing_poll"},
})
...
ServiceModule({
    Id="team_utility", Name="团队辅助", Category="combat", DataScope="character",
    Service=function() return S.Services and S.Services.TeamUtility end,
    OpenSettings=function() return S.UIHostManager and type(S.UIHostManager.OpenSettings)=="function" and S.UIHostManager:OpenSettings("team_utility") or false end,
    Tasks={
