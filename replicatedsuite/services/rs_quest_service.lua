...
Q.presentationBoundary = "service_only"
Q.presentationDebt = nil
                        ...
                        for _, entry in ipairs(list) do
                            if type(entry) == "table" and entry.type ~= nil then
                                ...
                                if key ~= nil and types[key] == nil then
                                    ...
                                    local instanceIds = S.GameIds and S.GameIds.Instance
                                    if instanceIds ~= nil and type(instanceIds.ObserveRuntimeCandidate) == "function" then
                                        instanceIds:ObserveRuntimeCandidate(key, entry.type, name)
                                    end
                                end
                            end
                        end
