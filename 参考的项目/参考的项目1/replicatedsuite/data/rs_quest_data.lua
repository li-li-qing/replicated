...
Activity("halcy", O.halcy or "为了势力荣誉的战争", {
    ...
    relatedObjectives = {
        { role = "英雄支援", quests = { 9130 } },
        { role = "英雄带队", quests = { 9223 } },
        { role = "英雄奖励", quests = { 9227 } },
        { role = "公会", quests = { 9000225 } },
    },
})
...
Activity("whalesong", O.whalesong or "鲸鱼歌湾", {
    { quests = { 8602, 8609, 8610, 8611 } },
    { quests = { 8603, 8612, 8613, 8614 } },
    { quests = { 8604, 8615, 8616, 8617 } },
}, {
    relatedObjectives = {
        { role = "总任务", quests = { 8637, 8638, 8639, 8640 } },
        { role = "Boss", quests = { 8605, 8606, 8607, 8608 } },
        { role = "公会", quests = { 9000220 } },
    },
})
...
Activity("crimson", O.crimson or "征兆之痕", {
    ...
    { quests = { 2942 } },
    { quests = { 2943 } },
    { role = "双猎犬 Boss", keepsEventAlive = true, quests = { 10729 } },
    { role = "暗影恶魔阶段", keepsEventAlive = true, quests = { 10730 } },
    { role = "Shadow Fang Boss", keepsEventAlive = true, quests = { 10734 } },
}, {
    relatedObjectives = {
        { role = "征兆守护任务", quests = { 8998 } },
        { role = "荣耀之路：猎犬", quests = { 5886 } },
        { role = "公会", quests = { 9000223 } },
    },
})
...
Activity("sungold_crimson", O.sungold_crimson or "煦日之野征兆", {
    ...
    { role = "双猎犬 Boss", keepsEventAlive = true, quests = { 10729 } },
    { role = "暗影恶魔阶段", keepsEventAlive = true, quests = { 10730 } },
    { role = "Xarkath Boss", keepsEventAlive = true, quests = { 10735 } },
}, {
    relatedObjectives = {
        { role = "征兆守护任务", quests = { 8998 } },
        { role = "荣耀之路：猎犬", quests = { 5886 } },
        { role = "公会", quests = { 9000223 } },
        { role = "煦日专属：安塔伦（荣耀之路）", keepsEventAlive = true, quests = { 5885 } },
        { role = "煦日专属：安塔伦（ArcheMaster）", keepsEventAlive = true, quests = { 7396 } },
    },
})
...
Activity("ghost", O.ghost or "迷雾战争", {
    ...
    relatedObjectives = {
        { role = "随机物资前置（任意一个）", quests = { 5138, 5139, 5140, 5150, 5151, 5152, 5153, 5154, 5155, 5156 } },
        { role = "投石车建设", quests = { 5142, 5157 } },
        { role = "Boss", quests = { 7648 } },
        { role = "Boss", quests = { 7649 } },
    },
})
...
Activity("aegis", O.aegis or "海之烛台", {
    { quests = { 8623, 8624, 8625, 8626 } },
    { quests = { 8627, 8628, 8629, 8630 } },
    { quests = { 8631, 8632, 8633, 8634 } },
}, {
    relatedObjectives = {
        { role = "总任务", quests = { 8641, 8642, 8643, 8644 } },
        { role = "Boss", quests = { 8618, 8619, 8620, 8621 } },
        { role = "公会", quests = { 9000221 } },
    },
})
...
Activity("jmg", O.jmg or "JMG", {
    ...
    relatedObjectives = {
        { role = "总任务", quests = { 5972 } },
        { role = "强化总任务", quests = { 9000467 } },
        { role = "强化 Boss", quests = { 10328 } },
        { role = "强化 Boss", quests = { 10329 } },
        { role = "强化 Boss", quests = { 10330 } },
    },
})
...
Activity("cinderstone_purify", "十字星平原债券奖励", {
    { quests = { 9960, 9962, 9963 } },
})
Activity("ynystere_purify", "伊尼斯泰尔债券奖励", {
    { quests = { 9964, 9965, 9966 } },
})
...
Activity("akasch_guard", "守山 / 守护伊弗尼尔山", {
    ...
    relatedObjectives = {
        { role = "总任务", quests = { 9000449 } },
        { role = "入侵日常", quests = { 10564 } },
        { role = "入侵日常", quests = { 10565 } },
        { role = "入侵日常", quests = { 10569 } },
        { role = "入侵日常", quests = { 10571 } },
        { role = "窥视之眼 2", quests = { 10699 } },
        { role = "窥视之眼 3", quests = { 10700 } },
        { role = "虚空罗盘 2", quests = { 10701 } },
        { role = "虚空罗盘 3", quests = { 10702 } },
        { role = "奥术球体 2", quests = { 10703 } },
        { role = "奥术球体 3", quests = { 10704 } },
        { role = "蛇卵", quests = { 10705 } },
        { role = "战斗情报", quests = { 10708 } },
    },
})
...
Activity("guardian_scramble", "大草原守护者争夺战", {
    { title = "神兽争夺战日常任务", quests = { 11096, 11116, 11131 } },
}, {
    relatedObjectives = {
        { role = "海盗支线", quests = { 11098 } },
        { role = "引导", quests = { 11099 } },
        { role = "胜利奖励", quests = { 11132, 11133 } },
    },
})
...
Activity("rookborne_festival", "洛卡试练庆典", {
    { title = "洛卡的试验庆典", quests = { 6761 } },
    { title = "洛卡的试炼：初学者挑战课程", quests = { 6758 } },
    { title = "洛卡的试炼：高手的挑战", quests = { 6759 } },
    { title = "挑战洛卡的试炼：专家", quests = { 7802 } },
    { title = "酒桶承载着大麦", quests = { 6784 } },
}, {
    activeFrom = "2026-08-19",
    activeUntil = "2026-09-01",
    relatedObjectives = {
        { role = "额外/兼容日常", quests = { 6760 } },
        { role = "额外/兼容日常", quests = { 6785 } },
        { role = "限时重复任务", quests = { 7803 } },
        { role = "限时重复任务", quests = { 7804 } },
    },
})
...
Activity("red_dragon", "红龙巢穴", {}, {
    kind = "instanceRaid",
    instanceRaid = {
        -- Expected per-account entry limit.  Completion is still computed from
        -- the live maxEnterCount reported by the server, so a server-side
        -- change to the limit does not break detection.
        maxEntry = 1,
        -- Localized instance names (zh_cn / en_us / ru) used for runtime
        -- discovery.  Order matters only for diagnostics: any candidate that is
        -- contained in the instance name matches this raid.
        matchNames = {
            "红龙巢穴", "红龙",
...
S.Data.QuestGroups = {
    daily = {
        { key = "guild", title = "公会任务", kind = "guildAchievement", quests = { 7736, 7737 } },
        { key = "pack20", title = "20货任务", quests = { 9000226 } },
        ActivityQuestGroups.halcy,
        { key = "resident", title = "居民任务", quests = { 8345, 8347, 8348, 8349, 8350, 8559, 8560, 8561, 8562, 8588, 8589, 8590, 8591, 8592, 8593 } },
        ...
        { key = "akasch_transfer_phenomenon", title = "打碎蛇卵", quests = { 10559 } },
        ...
        { key = "garden_daily", title = "神之庭院日常", objectives = {
            ...
            { role = "植物研究", quests = { 10145 } },
            { role = "植物研究", quests = { 10146 } },
            { role = "植物研究", quests = { 10147 } },
            { role = "植物研究", quests = { 10148 } },
            { role = "植物研究阵营任务", quests = { 10188, 10189 } },
        } },
        ...
        { key = "fish20", title = "20鱼任务", quests = { 9000531 } },
    },
    weekly = {
        { key = "west_hiram", title = "西部悉拉玛山脉周常", objectives = { { quests = { 9077 } }, { quests = { 11196 } } } },
        ...
        { key = "auroria_guard", title = "原大陆周常", objectives = {
            ...
            { role = "区域周常", quests = { 9019 } },
            { role = "区域周常", quests = { 9020 } },
            { role = "海盗阵营", quests = { 9021 } },
            { role = "海盗阵营", quests = { 9052 } },
            { role = "海盗阵营", quests = { 9053 } },
        } },
        { key = "akasch", title = "伊弗尼尔 / Akasch", quests = { 11200 } },
    },
}
...
S.Data.ResidentQuestIds = {
    [8345]=true,[8347]=true,[8348]=true,[8349]=true,[8350]=true,
    [8559]=true,[8560]=true,[8561]=true,[8562]=true,[8588]=true,
    [8589]=true,[8590]=true,[8591]=true,[8592]=true,[8593]=true,
}
