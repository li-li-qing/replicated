...
function F:Activate(id)
    ...
    if d.kind=="page" then if S.UI and S.UI.ShowPage then return S.UI:ShowPage(d.target)==true end
    ...
    elseif d.kind=="module" then
        ...
        if S.UI and S.UI.ShowPage then S.UI:ShowPage("modules"); return true end
    end
    return false
end
